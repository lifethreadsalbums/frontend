    ...
    function($state, DropdownComponent, StoreConfig, AngularDropdownComponent, 
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    React.createElement("ul", {className: ulClasses, onMouseUp: this.onClick}, 
                        ...
                        //    transitionLeaveTimeout={600}>
                                ...
                                containers.map(function (container, i) {
                                    ...
                                    return (
                                        React.createElement(PrintsContainerComponent, {
                                            key: container._id, 
                        ...
                        //</CSSTransitionGroup>
                            ...
                            isZoomed &&
                            React.createElement("span", {className: "prints-container__arrow prints-container__arrow--single prints-container__arrow--left", 
                                onClick: this.onContainerChange.bind(this, -1), 
                                "data-pace-tooltip": "See previous size"}, 
                                React.createElement("img", {className: "prints-container__arrow-icon prints-container__arrow-icon--single", 
                            ...
                            isZoomed &&
                            React.createElement("span", {className: "prints-container__arrow prints-container__arrow--single prints-container__arrow--right", 
                                onClick: this.onContainerChange.bind(this, 1), 
                                "data-pace-tooltip": "See next size"}, 
                                React.createElement("img", {className: "prints-container__arrow-icon prints-container__arrow-icon--single prints-container__arrow-icon--right", 
