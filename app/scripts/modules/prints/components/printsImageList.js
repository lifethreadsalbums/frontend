    ...
    function($state, $controller, StoreConfig) {
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                     React.createElement("div", {onMouseDown: this.props.onMouseDown, onMouseOver: this.props.onMouseOver, style: itemStyle}, 
                         React.createElement("div", {style: frameStyle}, 
                             React.createElement("img", {width: imageWidth, height: imageHeight, src: url, style: contentStyle})
                         )
                    )
                );
            }
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    ...
                    React.createElement("div", {id: "prints-containers-bottom", className: "prints-containers-bottom", tabIndex: "0", 
                         onMouseDown: this.onMouseDown, 
                         onKeyDown: this.onKeyDown}, 
                        React.createElement("div", {className: "prints-containers-bottom--wrapper"}, 
                                ...
                                elements.map(function (element, i) {
                                    ...
                                    return (
                                        ...
                                        React.createElement(PrintsImageItemComponent, {
                                            ref: ref, 
                                            element: element, 
