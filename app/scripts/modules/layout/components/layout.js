    ...
    var LayoutComponentClass = function(SpreadComponent, GeomService, $debounce) {
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    React.createElement("div", {className: containerClasses, onScroll: this.onLayoutScroll}, 

                        React.createElement("div", {className: "spread-placeholder", style: placeholderStyle}, " "), 
                        ...
                        spreads.map(function (spread, i) {
                            ...
                            return (
                                React.createElement("div", {key: i, className: "spread text-center", 
                                    onMouseOver: this.onMouseOver.bind(this, spread)}, 
                                    React.createElement("div", {className: "canvas-wrapper"}, 

                                        React.createElement("div", {className: topClasses}), 
                                        ...
                                        React.createElement("div", {className: bottomClasses})
