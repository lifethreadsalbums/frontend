        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    ...
                    React.createElement("div", {className: "spread user-select-none", 
                        onDragOver: this.onDragOver, onDragEnter: this.onDragEnter, 
                        onDragLeave: this.onDragLeave, onDrop: this.onDrop, 
                        onDoubleClick: this.onDoubleClick}, 
                        
                            leftPage ?
                            React.createElement("span", {className: "page-no page-left", style: pageLeftStyles}, leftLabel)
                            : null, 
                        

                        React.createElement("div", {className: thumbContainerClassSet, style: thumbContainerStyles}, 
                            React.createElement("canvas", {className: "thumb-canvas", 
                                width: this.canvasSize.width, 
                                height: this.canvasSize.height, 
                                style: canvasStyles}
                            ), 
                            React.createElement("div", {className: leftThumbClasses, 
                                style: thumbStyles, 
                            ...
                            React.createElement("div", {className: rightThumbClasses, 
                                style: thumbStyles, 
                            ...
                            React.createElement("div", {className: "dots"}, 
                                    ...
                                    React.createElement("span", {className: "dot dot--orange"})
                                
                            )
                        ), 
                        
                            rightPage ?
                            React.createElement("span", {className: "page-no page-right", style: pageRightStyles}, rightLabel)
                            : null
