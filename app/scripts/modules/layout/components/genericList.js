    ...
    return function createList(ItemRenderer) {
        ...
        return React.createClass({
                ...
                render: function() {
                    ...
                    return (
                        React.createElement("div", {className: "generic-list user-select-none", onScroll: this.onListScroll}, 
                            items.map(function (item, i) {
                             ...
                             this.state.canLoadNextPage ? React.createElement(FadingCircleComponent, null) : null
