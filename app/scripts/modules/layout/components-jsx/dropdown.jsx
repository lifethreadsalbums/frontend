...
.factory('DropdownComponent', [function() {
    ...
    return React.createClass({
        ...
        render: function() {
            ...
            return (
                <div className={dropdownClass} onMouseDown={this.onDropdownMouseDown} onMouseUp={this.onDropdownMouseUp}>
                    <span className="dropdown-r__label">{selectedItemLabel}</span>
                    <ul className={dropdownOptionsClass}>
                        {this.props.items.map(function(item) {
                            if (item.hidden) {
                                return '';
                            }
                            ...
                            return (
                                <li className={itemClassName}
                                    ...
                                    onMouseUp={this.onOptionMouseUp.bind(this,item.id)} key={item.id}>{item.label}</li>
                            )
                        }, this)}
                    </ul>
                </div>
