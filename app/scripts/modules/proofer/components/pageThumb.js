        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    ...
                    React.createElement("div", {className: "spread user-select-none", onMouseDown: this.onPageClick, 
                        onDoubleClick: this.onPageDoubleClick, 
                        ref: function(el) { that.thumbEl = el; }}, 
                        
                            !isSpreadBased && leftPage &&
                            React.createElement("span", {className: "page-no page-left"}, leftLabel), 
                        

                        React.createElement("div", {className: "thumb-container relative", style: thumbContainerStyles}, 
                            ...
                            React.createElement("span", {className: "page-no page-right"}, rightLabel), 
                        
                        
                            isSpreadBased && leftPage &&
                            React.createElement("span", {className: "page-no page-spread"}, leftLabel), 
