    ...
    function(EditListComponent, CommentListComponent, ProoferService, EditComponent, AngularDropdownComponent, MessageService) {
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                if (!this.props.layout) {
                    return ( <div className="proofer-component"></div> );
                }
                ...
                return (
                    <div className={prooferComponentClass}>

                        <div className="proofer-component__header">
                            
                            <header className="header-back dark small">
                                <button onClick={this.onBackClick} className="button dark back small double">Back</button>
                                <div>
                                    <h1>Comment Snapshots</h1>
                                    <small>See all your edits</small>
                                </div>
                            </header>
                        ...
                        <div className={prooferContentClass}>
                            <div className="proofer-component__list-wrapper" style={listWrapperStyles}>
                                ...
                                <div className="proofer-component__comments">
                        ...
                        <div className={prooferFooterClass}>
                            {
                                <div className="proofer__type-message">
                                    ...
                                    <button className="dark proofer__type-message__btn" onClick={this.onSendClick}>Send</button>
                                </div>
                            }
                            <button className="button dark clear-margin-bottom proofer-component__footer__approve-album" 
                                onClick={this.onApproveClick}>{approveLabel}</button>
                        </div>
                    </div>
                );
            }
