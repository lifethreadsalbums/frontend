    ...
    function($state, StoreConfig, $rootScope, $compile, SpreadComponent, FlipBookCoverComponent, GeomService,
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    <div className="flipboook__container">
                            ...
                            */}

                            {
                                pages.map(function (spread, i) {
                                    return (
                                        <div key={i} className={pageClass} style={pageStyle}>
                        ...
                        <span className="slideshow__prev" ref={refFn.bind(this, 'prevArrow')} onClick={this.onPrevClick}></span>
                        <span className="slideshow__next" ref={refFn.bind(this, 'nextArrow')} onClick={this.onNextClick}></span>
                    </div>
                );
            }
    ...
    function($state, StoreConfig, $rootScope, $compile) {
        return React.createClass({
            ...
            render: function() {
                ...
                return (
                    <div className="flipbook__cover hard" style={{width:'500px', height:'500px'}}></div>
                );
            }
