    ...
    function(AppConstants, ProoferPageThumbComponent, ProoferService) {
        ...
        return React.createClass({
            ...
            render: function() {
                ...
                var that = this;
                return (
                    <div className="proofer-pages" >
                        <div className="layout__page-thumbnails scrollable-content" ref={function(el) { that.container = el; }}>
                            <div className="active-area" ref={function(el) { that.activeArea = el; }}></div>
                            {
